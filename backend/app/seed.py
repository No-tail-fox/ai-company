...
def _item_definitions() -> list[tuple[str, str, str, str, str, str, str, str, str, str, int, bool, int]]:
    items: list[tuple[str, str, str, str, str, str, str, str, str, str, int, bool, int]] = [
        ...
        ("comm-02", "section-communities", "community", "学习打卡群", "每日任务、案例拆解和作业反馈", "社群", "GraduationCap", "", "route", "/community/study", 20, True, 0),
        ("comm-03", "section-communities", "community", "接单变现群", "接单案例、报价模板和交付流程", "社群", "Handshake", "", "route", "/community/orders", 30, True, 0),
        ("comm-04", "section-communities", "community", "垂直赛道群", "短视频、电商、教育和办公赛道", "社群", "Network", "", "route", "/community/vertical", 40, True, 0),
        ("banner-01", "section-banners", "banner", "热门模板上新！", "一键轻松取用办公模板", "运营活动", "Gift", "linear-red", "route", "/templates", 10, True, 0),
        ("banner-02", "section-banners", "banner", "商业计划书模板", "融资路演、商业策划、项目计划", "模板", "ChartColumn", "linear-blue", "route", "/templates/business", 20, True, 0),
        ("banner-03", "section-banners", "banner", "邀请内测", "免费体验全新AI办公助理", "活动", "Sparkles", "linear-purple", "route", "/trial", 30, False, 0),
    ]
    page_tools = {
